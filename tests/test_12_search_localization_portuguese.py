...
def search_localization(token, client, hierarchy_type, locale="pt_MZ"):
    """
...
@allure.title("Test Search Localization Messages - Portuguese")
@allure.description("Searches for localization messages in Portuguese locale (pt_MZ)")
